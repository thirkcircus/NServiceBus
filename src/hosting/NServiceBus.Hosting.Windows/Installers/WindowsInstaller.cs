...
namespace NServiceBus.Hosting.Windows.Installers
{
    ...
    public class WindowsInstaller
    {
        ...
        static void DomainInitializer(string[] args)
        {
            ...
            host = new WindowsHost(Type.GetType(arguments.EndpointConfigurationType.Value, true), args, endpointName, arguments.Install, (arguments.InstallInfrastructure != null), scannedAssemblies);
        }
